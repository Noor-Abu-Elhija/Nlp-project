...
from environments.attenionLstm import AttenionLstm
from consts import *


class LSTMAtt_env_ARC(AttenionLstm):
...
class LSTMAtt_env(environment.Environment):
    def init_model_arc(self, config):
        self.model = LSTMAtt_env_ARC(n_layers=self.n_layers, input_dim=config['input_dim'], hidden_dim=self.hidden_dim,
