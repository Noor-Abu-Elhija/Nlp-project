...
from environments.Attention import FCAtenttion
from consts import *


class Attention_env_ARC(FCAtenttion):
...
class Attention_env(environment.Environment):
    def init_model_arc(self, config):
        self.model = Attention_env_ARC(n_layers=self.n_layers, input_dim=config['input_dim'], hidden_dim=self.hidden_dim,
