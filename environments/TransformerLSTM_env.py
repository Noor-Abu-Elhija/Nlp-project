...
from environments.TransformerLstm import TransformerLstm
from consts import *


class LSTM_Transformer_env_ARC(TransformerLstm):
...
class TransformerLSTM_env(environment.Environment):
    def init_model_arc(self, config):
        self.model = LSTM_Transformer_env_ARC(n_layers=self.n_layers, tr_layers=self.tr_layers, n_heads=self.n_heads_first,
